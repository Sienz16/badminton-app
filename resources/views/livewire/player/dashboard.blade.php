    ...
    <div class="flex h-full w-full flex-1 flex-col gap-8 p-5">
        ...
        <div>
            <div class="mb-4 flex items-center justify-between">
                ...
                <a href="{{ route('player.matches') }}" class="inline-flex items-center gap-1 text-sm text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300" wire:navigate>
                    View all
                ...
                @forelse($todayMatches as $match)
                    ...
                    <a href="{{ route('player.matches.show', $match) }}" 
                       class="group relative block overflow-hidden rounded-xl border-2
                              {{ $match->isMyMatch ? 'border-blue-500/50' : 'border-green-400/50' }} 
                       ...
                       wire:navigate>
                        ...
                        @if($match->isMyMatch)
                            <div class="absolute bottom-4 right-4">
                                <span class="inline-flex items-center gap-1.5 rounded-full bg-blue-100 px-3 py-1 
