    ...
    <div class="flex h-full w-full flex-1 flex-col gap-8">
        ...
        <div>
            <div class="mb-4 flex items-center justify-between">
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">My Today's Matches</h2>
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                @forelse($todayMatches as $match)
                    <a href="{{ route('umpire.matches.show', $match) }}" 
                       class="group relative block overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 transition hover:border-blue-500/50 hover:shadow-sm dark:border-neutral-700 dark:bg-zinc-900 dark:hover:border-blue-500/50"
                       wire:navigate>
                        @if($match->isLive())
                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-12 w-12 items-center justify-center rounded-full bg-neutral-100 text-sm font-semibold text-neutral-900 dark:bg-neutral-800 dark:text-white">
                            ...
                            <!-- Venue -->
                            <div class="flex items-center gap-2 rounded-lg border border-neutral-200 bg-neutral-50 px-3 py-2 text-sm text-neutral-600 dark:border-neutral-800 dark:bg-neutral-800/50 dark:text-neutral-400">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-4 w-4">
                ...
                @empty
                    <div class="col-span-full rounded-xl border border-neutral-200 bg-white p-8 text-center dark:border-neutral-700 dark:bg-zinc-900">
                        ...
                        <h3 class="mb-1 text-sm font-medium text-neutral-900 dark:text-white">No Matches Today</h3>
                        <p class="text-sm text-neutral-600 dark:text-neutral-400">You have no matches scheduled for today.</p>
                    </div>
                @endforelse
            </div>
        </div>
